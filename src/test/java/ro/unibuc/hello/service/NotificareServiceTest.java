...
public class NotificareServiceTest {
    ...
    void setUp() {
        ...
        notificareService = new NotificareService(notificareRepository, userRepository, eventService);
    }
    ...
    public void testAcceptInvitation() {
        ...
        verify(notificareRepository, times(1)).save(captor.capture());
        Notificare captured = captor.getValue();

        assertEquals(notificareId, captured.getNotificareId());
        assertTrue(captured.getVerificare());
